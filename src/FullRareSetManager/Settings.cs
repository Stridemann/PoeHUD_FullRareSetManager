...
namespace FullRareSetManager
{
    public class FullRareSetManagerSettings : SettingsBase
    {
        ...
        [Menu("Allow Identified Items")] public ToggleNode AllowIdentified { get; set; }

        [Menu("Show only with inventory")] public ToggleNode ShowOnlyWithInventory { get; set; }

        [Menu("Hide when left panel opened")] public ToggleNode HideWhenLeftPanelOpened { get; set; }
        [Menu("Show Regal sets")] public ToggleNode ShowRegalSets { get; set; }
        ...
        [Menu("Items Lables Borders", 0)] public ToggleNode EnableBorders { get; set; }

        [Menu("Inventory Borders")] public ToggleNode InventBorders { get; set; }

        [Menu("Borders Width", 1, 0)] public RangeNode<int> BorderWidth { get; set; }
        [Menu("Borders Oversize", 2, 0)] public RangeNode<int> BorderOversize { get; set; }
        ...
        [Menu("Text Size", 4, 0)] public RangeNode<int> TextSize { get; set; }

        [Menu("Text Offset X", 5, 0)] public RangeNode<float> TextOffsetX { get; set; }
        [Menu("Text Offset Y", 6, 0)] public RangeNode<float> TextOffsetY { get; set; }
        ...
        [Menu("Ignore Elder/Shaper items")] public ToggleNode IgnoreElderShaper { get; set; } = true;
